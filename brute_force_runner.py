...
def _parse_history_row(row: list, idx: dict) -> tuple:
    ...
    res = {
        ...
        "local_belief_master": sf('local_belief Master') if sf('local_belief Master') != float('inf') else 0.0,
        "local_belief_slave": sf('local_belief Slave') if sf('local_belief Slave') != float('inf') else 0.0,
