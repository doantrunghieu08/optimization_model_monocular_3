...
def run_test(target_pair_str=None):
    ...
    print(f" - Fusion Occ MPJPE  : {res.get('fusion_occ_mpjpe', 0):.2f} mm")
    print(f" - Fusion Vis MPJPE  : {res.get('fusion_vis_mpjpe', 0):.2f} mm")
    ...
    print(f" - LE MPJPE Master   : {res.get('le_mpjpe_master', 'N/A')} mm")
    print(f" - LE Occ MPJPE (occ): {res.get('le_occ_mpjpe_master', float('inf')):.2f} mm")
    print(f" - LE Vis MPJPE (vis): {res.get('le_vis_mpjpe_master', float('inf')):.2f} mm")
