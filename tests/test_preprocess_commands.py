...
from preprocess_pipeline.extract_2d import _build_2d_camera_payload, _load_tracking_payload
...
class PreprocessCommandTest(unittest.TestCase):
    ...
    def test_tracking_falls_back_to_sibling_file(self):
        with TemporaryDirectory() as directory:
            ...
            with patch("preprocess_pipeline.extract_2d.load_joblib_compat", side_effect=payloads):
