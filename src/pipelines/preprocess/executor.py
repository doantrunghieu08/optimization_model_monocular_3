...
from src.pipelines.preprocess.logs import log_module_done
from src.pipelines.preprocess.extract_2d import export_tracking_2d_to_camera_profiles
from src.pipelines.preprocess.logs import log_module_start
from src.pipelines.preprocess.calib import export_camera_jsons
from src.pipelines.preprocess.logs import log_offset_selected
from src.pipelines.preprocess.offset_paper import compute_offset_from_pkls
from src.pipelines.preprocess.calib import resolve_selected_offset_from_camera_profile
...
def run_offset_estimation(
    ...
    offset = compute_offset_from_pkls(
        pkl1,
        pkl2,
        smpl_model_path,
        j_regressor_path,
...
def run_preprocess(config: dict, extract_frames: bool = True) -> tuple[int, str]:
    ...
    j_regressor_path = paths.get("j_regressor_3d", "optimization_model_monocular/models/J_regressor_body25_plus_palm27.npy")
