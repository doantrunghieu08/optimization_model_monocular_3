...
from src.pipelines.pose.smpl_runner import create_smpl_model
from src.core.config_loader import resolve_inputs
from src.pipelines.pose.smpl_runner import get_3d_joints_for_frame
...
def load_pkl_data(file_path):
    ...
    person_data = _extract_person_payload(load_joblib_compat(file_path))
